...
def plot_qxxx(qxxx, joint_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('folders/traj_standard/graphs/UKF1_qpos.png')  # Save the plot to a file
...
def plot_qxxx_2d(qxxx, joint_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('folders/traj_standard/graphs/UKF1_qfrc.png')  # Save the plot to a file
    plt.close()  # Close the figure to free memory
def plot_uxxx_2d(uxxx, muscle_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('folders/traj_standard/graphs/UKF1_ctrl.png')  # Save the plot to a file
    plt.close()  # Close the figure to free memory
...
output_path = os.path.join(os.path.dirname(__file__), "kinematics_predicted_ukf1.csv")
