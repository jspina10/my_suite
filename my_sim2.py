...
def plot_qxxx(qxxx, joint_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('graphs/UKF2_qpos_sim2.png')  # Save the plot to a file
...
def plot_qxxx_2(qxxx, joint_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('graphs/UKF2_qfrc_sim2.png')  # Save the plot to a file
    plt.close()  # Close the figure to free memory
...
def plot_uxxx_2(uxxx, muscle_names, labels):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('graphs/UKF2_ctrl_sim2.png')  # Save the plot to a file
    plt.close()  # Close the figure to free memory
...
output_name = os.path.join(os.path.dirname(__file__), "videos/my_sim2.mp4")
